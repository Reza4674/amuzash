...
@section('maincontent')
    ...
    <div class="col-md-8">
        <div class="col-md-6">
            ...
            <form style="padding:15px; border-radius:15px" class="bg-white mt-5" enctype="multipart/form-data" method="post" action="{{route('admin.offer.update',['offer'=>$offer->id])}}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" id="body" cols="58" rows="5">{{$offer->body}}</textarea>
                    </div>
