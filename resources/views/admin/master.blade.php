...
<div class="wrapper">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="#" class="nav-link active bg-success-gradient">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="#" class="nav-link active bg-danger-gradient">
                                <i class="nav-icon fa fa-dashboard"></i>
                                <p>
                                    درباره ما
                                    <i class="right fa fa-angle-left"></i>
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="#" class="nav-link active bg-gray">
                                <i class="nav-icon fa fa-dashboard"></i>
                                <p>
                                    اخرین پروژه ها
                                    <i class="right fa fa-angle-left"></i>
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('admin.offer.create')}}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
    ...
    <footer class="main-footer">
        <strong>CopyLeft &copy; 2020 <a href="http://github.com/hesammousavi/">وب</a>.</strong>
    </footer>
